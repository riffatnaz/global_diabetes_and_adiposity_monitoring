...
3.	Country Deep Dive: country-level KPI cards, sex-split prevalence trend line, stacked BMI-band distribution over time, treatment-coverage gender comparison
4.	Risk Relationships: animated scatterplot (obesity % vs. diabetes prevalence, play axis by year, coloured by continent) with trend line; diabetes-to-obesity ratio by continent
5.	Gender & Treatment Equity: gender-gap KPIs, region × sex prevalence comparison, gender-gap trend over time, top-burden countries ranked by treatment coverage
## Reproducibility
